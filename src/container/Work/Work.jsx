...
const Work = () => {
  ...
  useEffect(() => {
    const query = '*[_type == "works"]{title, description, imgUrl, projectLink, codeLink, "tagName": tag->name}';
    const tagQuery = '*[_type == "workTags"]';
  ...
  const handleWorkFilter = (item) => {
    ...
    setTimeout(() => {
      ...
      if(item === 'All') {
        ...
        setFilterWork(works.filter(work => work.tagName === item))
      }
    }, 500);
  }
          ...
          <div className='app__work-item app__flex' key={index}>
            ...
            <div className='app__work-content app__flex'>
              ...
              <div className='app__work-tag app__flex'>
                <p className='p-text'>{work.tagName}</p>
              </div>
            </div>
